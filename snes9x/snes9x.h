...
#else
#define STREAM					FILE *
#define READ_STREAM(p, l, s)	(printf("read stream %d\n", l),fread(p, 1, l, s))
#define WRITE_STREAM(p, l, s)	fwrite(p, 1, l, s)
#define GETS_STREAM(p, l, s)	(printf("gets stream \n"),fgets(p, l, s))
#define GETC_STREAM(s)			(printf("getc stream \n"),fgetc(s))
#define OPEN_STREAM(f, m)		(printf("fopen %s\n", f), fopen(f, m))
#define REOPEN_STREAM(f, m)		(printf("fopen %s\n", f), fdopen(f, m))
